...
class HomeViewController: UIViewController {
    ...
    private func defineInitialLocation() {
        let initialLocation = CLLocationCoordinate2D(latitude: -23.5611, longitude: 46.6564)
    ...
    private func addAnnotationsToMap(){
        ...
        if let firstAnnotation = annotations.first {
            homeView.mapView.setRegion(MKCoordinateRegion(center: firstAnnotation.coordinate, span: MKCoordinateSpan(latitudeDelta: 0.5, longitudeDelta: 0.5)), animated: true)
        }
    }
...
extension HomeViewController: MKMapViewDelegate {
    ...
    func mapView(_ mapView: MKMapView, annotationView view: MKAnnotationView, calloutAcessoryControlTrapped control: UIControl) {

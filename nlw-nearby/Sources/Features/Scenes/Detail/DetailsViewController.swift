...
//  nlw-nearby
//
//  Created by David Santos on 20/12/24.
//
...
class DetailsViewController: UIViewController {
    ...
    private let couponStackView: UIStackView = {
        ...
        stackView.layoutMargins = UIEdgeInsets(top: 0, left: 8, bottom: 10, right: 8)
        return stackView
    }()
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            coverImageView.leadingAnchor.constraint(equalTo: contentView.trailingAnchor),
